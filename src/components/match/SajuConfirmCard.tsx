...
function Pillar({ label, ju }: { label: string; ju: Ju | null }) {
  if (!ju) {
    return (
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8">
      ...
      <div className="flex justify-center gap-3 sm:gap-4 mb-6">
        <Pillar label={t.hour} ju={saju.saju.hour} />
        <Pillar label={t.day} ju={saju.saju.day} />
        <Pillar label={t.month} ju={saju.saju.month} />
        <Pillar label={t.year} ju={saju.saju.year} />
      </div>
