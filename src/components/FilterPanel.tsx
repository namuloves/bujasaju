...
const INDUSTRY_KO: Record<string, string> = {
  // From legacy Forbes categories
  'Automotive': '자동차',
  'Automotive Parts': '자동차 부품',
  'Automotive/Construction': '자동차·건설',
  'Construction & Engineering': '건설·엔지니어링',
  'Construction': '건설',
  'Diversified': '복합기업',
  'Conglomerate': '복합기업',
  'Conglomerate succession': '복합기업 (승계)',
  'Energy': '에너지',
  'Energy/Infrastructure': '에너지·인프라',
  'Energy/Retail': '에너지·유통',
  ...
  'Sportswear': '스포츠웨어',
  'Beauty': '뷰티',
  'Cosmetics & pharma OEM': '화장품·제약 OEM',
  ...
  'Healthcare': '헬스케어',
  'Pharmaceuticals': '제약',
  'Pharmaceuticals + aesthetics': '제약·미용',
  'Biopharma': '바이오제약',
  'Aesthetic pharma': '미용 제약',
  'Medical devices': '의료기기',
  'In-vitro diagnostics': '체외 진단',
  'Molecular diagnostics': '분자 진단',
  'Logistics': '물류',
  'Manufacturing': '제조',
  'Media & Entertainment': '미디어·엔터테인먼트',
  'Media': '미디어',
  'Entertainment': '엔터테인먼트',
  'Entertainment M&A': '엔터테인먼트 M&A',
  'Film': '영화',
  'Music': '음악',
  'TV': '방송',
  'YouTube': '유튜브',
  'Travel YouTube': '여행 유튜브',
  'K-pop solo artist, actress': '솔로 가수·배우',
  'Acting + household wealth': '연기·가문 자산',
  'Trot': '트로트',
  'MC': '방송 진행',
  'Arts': '예술',
  'Metals & Mining': '금속·광업',
  'Mining/Metals': '광업·금속',
  'Non-ferrous metals': '비철금속',
  'Specialty steel': '특수강',
  'Steel': '철강',
  'Steel pipe': '강관',
  'Steel pipes': '강관',
  ...
  'Golf': '골프',
  'Golf → 바즈인터내셔널': '골프',
  'Ex-KBL basketball': '농구 (전 KBL)',
  'Technology': '기술',
  'Internet/Technology': '인터넷·기술',
  'Semiconductors': '반도체',
  ...
  'E-commerce': '이커머스',
  'Retail': '유통',
  'Department stores, retail': '백화점·유통',
  'Department stores, home-shopping, home-living': '백화점·홈쇼핑·홈리빙',
  'Convenience stores, supermarkets, home shopping': '편의점·슈퍼·홈쇼핑',
  'Education': '교육',
  'Defense/Aerospace': '방산·항공우주',
  'Airlines': '항공',
  'Chemicals': '화학',
  'Chemicals/Tires': '화학·타이어',
  'Chemicals, textiles, fashion, real estate': '화학·섬유·패션·부동산',
  'Tires': '타이어',
  'Textile': '섬유',
  'Batteries/Energy': '배터리·에너지',
  'Building materials': '건축 자재',
  'Cable manufacturing': '케이블 제조',
  'LPG distribution': 'LPG 유통',
  'Venture': '벤처',
};
