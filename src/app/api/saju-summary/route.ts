...
1) 일주·월지 풀이 (2-3문장) — ${user.ilju} 일주의 핵심 성격을 먼저. 위 "${user.ilju} 일주 해석" 데이터의 traits 키워드를 활용. 그 다음 월지 ${user.wolji}가 일간에게 어떤 구체적 영향을 주는지 — 데이터에 있는 사실 그대로. "깊이 있는 안정성을 더해줍니다" 같은 빈말 절대 금지. 월지가 십신·계절·통근으로 어떻게 작용하는지 한 가지 구체적인 효과만 짚을 것 ("재물운이 약해진다 / 결단력이 빨라진다 / 인간관계로 일이 풀린다" 등). "큰 나무", "깊은 물" 같은 오행 자연물 비유 금지.
...
- **번역체/공문서체 절대 금지.** "제공합니다", "확대해줍니다", "부여합니다", "가져다줍니다", "선사합니다", "더해줍니다", "발휘하게 해줍니다", "이끌어내는", "필수적인 요소로 작용합니다" 사용 금지.
