...
import CleanNav from "@/components/browse-clean/CleanNav";
...
export default function AboutPage() {
  return (
    <>
      {/* Same header as the rest of the site. No activeTab/onChange: this
          page is not one of the tabs, so nothing is underlined and the tabs
          render as links back into the app. */}
      <CleanNav />
